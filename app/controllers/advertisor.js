...
exports.detail = function(req, res){
  ...
  {
     pool.query("select A.*,C.is_country_divided from advertisor as A, campaign C where A.campaign_id=C.id  and A.adv_id="+req.params.adv_id,function(err,rows){
...
exports.save = function(req, res){
  ...
  {
    var insert_sql = "insert into advertisor (adv_name,campaign_id,enabled_time,country,redirect_id,is_divisor_needed,type,active) values ('"+req.body.adv_name+"',"+req.body.campaign_id+","+req.body.enabled_time+",'"+req.body.country+"',"+req.body.redirect_id+","+req.body.is_divisor_needed+","+req.body.type+",1 )";
  ...
  if(typeof(req.body.advertisor_id) != "undefined")
  {
    ...
    var update_sql = "update advertisor set adv_name='"+req.body.adv_name+"',enabled_time="+enabled_time+",country='"+req.body.country+"',redirect_id="+req.body.redirect_id+",is_divisor_needed="+req.body.is_divisor_needed+", active="+req.body.active+", type="+req.body.type+" where adv_id="+req.body.advertisor_id;
